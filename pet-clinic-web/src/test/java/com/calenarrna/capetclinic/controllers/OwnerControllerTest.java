...
class OwnerControllerTest {
    ...
    void setUp() {
        owners = new HashSet<>();
        testOwner = Owner.builder().id(1L).build();
    ...
    void processCreationForm() throws Exception {
        when(ownerService.save(ArgumentMatchers.any())).thenReturn(testOwner);
    ...
    void initUpdateOwnerForm() throws Exception {
        when(ownerService.findById(ArgumentMatchers.anyLong())).thenReturn(testOwner);
